/*
 *
 * ©K. D. Hedger. Sat 12 Nov 15:16:35 GMT 2016 keithdhedger@gmail.com
...
struct humanUnitsStruct
{
	double number;
	char suffix;
};

enum	{CONTEXTNEWFILE=0,CONTEXTNEWFOLDER,CONTEXTBMNEW,CONTEXTOPEN,CONTEXTRENAME,CONTEXTDELETE,CONTEXTDUP,CONTEXTEXTRACT,CONTEXTCOPY,CONTEXTPROPS,CONTEXTPASTE,CONTEXTSHOW,CONTEXTHIDE,CONTEXTDISKMOUNT,CONTEXTDISKUNMOUNT,CONTEXTDISKEJECT,CONTEXTBMOPEN,CONTEXTBMDELETE,MAINFILENEW,MAINFILETERMINAL,MAINFILEPREFS,MAINFILEQUIT,MAINHELPABOUT,MAINTOOLSBLANKTOOL};

enum {LOADHIDENFOLDERS=0,LOADFOLDERs,LOADHIDDENFILES,LOADFILES,LOADPIXMAPS};
